...
#cat commandpairs.txt  para-nmt-50m-demo/para-nmt-50m-small.txt  > commandpairsextsmall.txt
#cat commandpairs.txt  para-nmt-50m/para-nmt-50m.txt  > commandpairsext.txt
